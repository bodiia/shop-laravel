            ...
            <section class="flex flex-col lg:flex-row gap-10 xl:gap-14 2xl:gap-20 mt-12">
                ...
                <div class="basis-full lg:basis-3/5 xl:basis-2/4">
                    <div class="grow flex flex-col lg:py-8">
                        ...
                        <!-- Add to cart -->
                        <form class="space-y-8 mt-8" action="{{ route('cart.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4">
                                @foreach($options as $option => $values)
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <select name="option_values[]" id="filter-item-1" class="form-select w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition">
